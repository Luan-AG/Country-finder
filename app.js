...
btnSearch.addEventListener('click', function(e){
    ...
    /* const getCountryData = function (country) {
        ...
        request.onload = function () {
          ...
          function pop(){
              if(data.population >= 1000000) {
                  return (data.population / 1000000).toFixed(1) + 'M ';
              } else {
                  return (data.population / 1000).toFixed(1) + 'K ';
              }
          }
          const html = `
            <article class="country">
            ...
            <div class="country__data">
                <h3 class="country__name">${data.name}</h3>
                <h4 class="country__region">(${data.region})</h4>
                <p class="country__row"><span class="tooltip">&#127988<span class="tooltiptext">Capital City</span></span>${data.capital}</p>
                <p class="country__row"><span class="tooltip">👫 <span class="tooltiptext">Population</span></span>${pop()}people</p>
                <p class="country__row"><span class="tooltip">🗣️ <span class="tooltiptext">Language</span></span>${data.languages[0].name}</p>
                <p class="country__row"><span class="tooltip">💰 <span class="tooltiptext">Currency</span></span>${data.currencies[0].name}</p>
            </div>
            </article>
            `;
          countriesContainer.insertAdjacentHTML('beforeend', html);
